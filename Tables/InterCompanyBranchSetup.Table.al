Table 50098 "InterCompany Branch Setup"
{
    ...
    fields
    {
        ...
        field(6; "Due To Account Type"; Enum "Gen. Journal Account Type")
        {
        ...
        field(7; "Due To Account No."; Code[20])
        {
            ...
            if ("Due To Account Type" = const(Customer)) Customer
            else
            if ("Due To Account Type" = const(Vendor)) Vendor
            else
            if ("Due To Account Type" = const("Bank Account")) "Bank Account"
            else
            if ("Due To Account Type" = const("IC Partner")) "IC Partner";
        }
        ...
        field(10; "Due From Account Type"; Enum "Gen. Journal Account Type")
        {
        ...
        field(11; "Due From Account No."; Code[20])
        {
            ...
            if ("Due From Account Type" = const(Customer)) Customer
            else
            if ("Due From Account Type" = const(Vendor)) Vendor
            else
            if ("Due From Account Type" = const("Bank Account")) "Bank Account"
            else
            if ("Due From Account Type" = const("IC Partner")) "IC Partner";
        }
